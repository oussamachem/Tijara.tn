    ...
    <div>
      ...
      <div className="p-4">
        ...
        <div className="mt-4 space-y-2">
          ...
          {/* Self-service de création de boutique = Phase B. Bouton présent mais inactif (ne casse rien). */}
          <button
            type="button"
            disabled
            title="Bientôt disponible"
            className="flex w-full items-center justify-between rounded-xl border border-dashed border-slate-200 bg-white px-4 py-3.5 text-sm font-medium text-slate-400"
          >
            🏪 Créer ma boutique <span className="rounded-full bg-slate-100 px-2 py-0.5 text-[10px] font-bold text-slate-400">Bientôt</span>
          </button>
        </div>
